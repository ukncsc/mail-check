module "lambdaAPI-aggregate-headline" {
  ...
  lambda-function-name	= "TF-${var.env-name}-AggregateReportApi_GetAggregatedHeadlineStatistics"
  handler		= "Dmarc.AggregateReport.Api::Dmarc.AggregateReport.Api.AggregateReportApi::GetAggregatedHeadlineStatistics"
