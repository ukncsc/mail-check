module "lambdaAPI-aggregate-trust" {
  ...
  lambda-function-name	= "TF-${var.env-name}-AggregateReportApi_GetAggregatedTrustStatistics"
  handler		= "Dmarc.AggregateReport.Api::Dmarc.AggregateReport.Api.AggregateReportApi::GetAggregatedTrustStatistics"
