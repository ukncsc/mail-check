module "lambdaAPI-daily-compliance" {
  ...
  lambda-function-name	= "TF-${var.env-name}-AggregateReportApi_GetDailyComplianceStatistics"
  handler		= "Dmarc.AggregateReport.Api::Dmarc.AggregateReport.Api.AggregateReportApi::GetDailyComplianceStatistics"
