module "dnsrecord-dmarc-processor" {
  ...
  lambda-function-name	= "TF-${var.env-name}-dnsrecord-dmarc-processor"
  handler		= "Dmarc.DnsRecord.Importer.Lambda::Dmarc.DnsRecord.Importer.Lambda.DmarcRecordImporter::HandleScheduledEvent"
