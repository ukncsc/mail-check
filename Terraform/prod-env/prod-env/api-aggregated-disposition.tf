module "lambdaAPI-aggregate-disposition" {
  ...
  lambda-function-name	= "TF-${var.env-name}-AggregateReportApi_GetAggregatedDispositionStatistics"
  handler		= "Dmarc.AggregateReport.Api::Dmarc.AggregateReport.Api.AggregateReportApi::GetAggregatedDispositionStatistics"
