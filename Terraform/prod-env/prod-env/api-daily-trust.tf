module "lambdaAPI-daily-trust" {
  ...
  lambda-function-name	= "TF-${var.env-name}-AggregateReportApi_GetDailyTrustStatistics"
  handler		= "Dmarc.AggregateReport.Api::Dmarc.AggregateReport.Api.AggregateReportApi::GetDailyTrustStatistics"
