    ...
    "widgets": [
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "metrics": [
                    [ "AWS/S3", "BucketSizeBytes", "StorageType", "StandardStorage","BucketName", "${aws_s3_bucket.forensic-bucket.id}",  { "period": 86400 } ]
                ],
                "region": "${var.aws-region}",
                "title": "${aws_s3_bucket.forensic-bucket.id}-Size",
                "period": 86400
            }
        },
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "metrics": [
                    [ "AWS/S3", "NumberOfObjects", "BucketName", "${aws_s3_bucket.forensic-bucket.id}", "StorageType", "AllStorageTypes"  ]
                ],
                "region": "${var.aws-region}",
                "title": "${aws_s3_bucket.forensic-bucket.id}-Object-Count",
                "period": 86400
            }
        },
            {
