...
{
    [TestFixture]
    public class MxRecordProcessorFactoryTests
    {
        [Test]
        public void MxRecordProcessorCorrectedCreated()
        {
            ...
            IDnsRecordProcessor recordProcessor = MxRecordProcessorFactory.Create(A.Fake<ILogger>());
