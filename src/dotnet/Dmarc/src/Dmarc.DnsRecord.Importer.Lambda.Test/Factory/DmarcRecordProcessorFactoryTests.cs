...
{
    [TestFixture]
    public class DmarcRecordProcessorFactoryTests
    {
        [Test]
        public void DmarcRecordProcessorCorrectedCreated()
        {
            ...
            IDnsRecordProcessor recordProcessor = DmarcRecordProcessorFactory.Create(A.Fake<ILogger>());
