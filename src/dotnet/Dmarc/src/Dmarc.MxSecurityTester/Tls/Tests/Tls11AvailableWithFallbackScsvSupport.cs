...
{
    public class Tls11AvailableWithFallbackScsvSupport : ITlsTest
    {
        public int Id => 5;

        public string Name => nameof(Tls11AvailableWithFallbackScsvSupport);

        public TlsVersion Version => TlsVersion.TlsV11;
