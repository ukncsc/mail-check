...
{
    [TestFixture]
    public class RuaTagShouldNotHaveMoreThanTwoUrisTest
    {
        private RuaTagShouldNotHaveMoreThanTwoUris _rule;
        ...
        public void Test(int tagCount, bool isErrorExpected)
        {
            ...
            DmarcRecord dmarcRecord = new DmarcRecord("", new List<Tag> { reportUriAggregate }, string.Empty);
