...
{
    public interface ITls12AvailableWithWeakCipherSuiteNotSelected : ITlsEvaluator { }

    public class Tls12AvailableWithWeakCipherSuiteNotSelected : ITls12AvailableWithWeakCipherSuiteNotSelected
    {
