...
{
    public class Tls11AvailableWithBestCipherSuiteSelected : ITlsEvaluator
    {
        ...
        {
            TlsConnectionResult tlsConnectionResult = tlsConnectionResults.Tls11AvailableWithBestCipherSuiteSelected;
