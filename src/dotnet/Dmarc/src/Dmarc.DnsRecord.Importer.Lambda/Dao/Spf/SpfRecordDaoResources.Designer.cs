...
namespace Dmarc.DnsRecord.Importer.Lambda.Dao.Spf {
    ...
    public class SpfRecordDaoResources {
        
        private static global::System.Resources.ResourceManager resourceMan;
        
        private static global::System.Globalization.CultureInfo resourceCulture;
        
        internal SpfRecordDaoResources() {
        }
        ...
        public static global::System.Resources.ResourceManager ResourceManager {
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("Dmarc.DnsRecord.Importer.Lambda.Dao.Spf.SpfRecordDaoResources", typeof(SpfRecordDaoResources).GetTypeInfo().Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// <summary>
        ///    Looks up a localized string similar to INSERT INTO dns_record_spf
        ///(`id`,
        ///`domain_id`,
        ///`record`,
        ///`end_date`,
        ...
        ///MAX(COALESCE(s1.last_checked, &apos;1900-01-01&apos;)) as lst_checked
        ///FROM domain d1
        ///LEFT JOIN dns_record_spf s1 ON d1.id = s1.domain_id
        ///WHERE (d1.publish = b&apos;1&apos; OR d1.monitor = b&apos;1&apos; )
        ///AND s1.end_date IS NULL
        ///AND (s1.id IS NULL ||
        ///	(UTC_TIMESTAMP() &gt; DATE_ADD(s1.last_checked, INTERVAL @refreshIntervalSeconds SECOND) &amp;&amp; s1.failure_count &lt;= 0) ||
        ///	(UTC_TI [rest of string was truncated]&quot;;.
        /// </summary>
